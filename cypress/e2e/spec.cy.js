...
describe('On page load', () => {
  it('Should display a title, a form, and three preloaded tricks', () => {
    ...
    cy.get('.cards > :nth-child(1)').contains('a', 'https://www.youtube.com/watch?v=XGw3YkQmNig')
  })
})
...
describe('Adding a new trick', () => {
  it('passes', () => {
    ...
    //click submit button
    cy.get('button.form-input').click()
    //check that the page shows
      ...
      cy.get('.cards > :nth-child(4)').contains('h2', 'regular Trick Name')
      cy.get('.cards > :nth-child(4) > :nth-child(2)').contains('p', 'Obstacle: flatground')
      cy.get('.cards > :nth-child(4) > :nth-child(3').contains('p', 'Link to Tutorial')
      cy.get('.cards > :nth-child(4)').contains('a', 'Link Goes Here')
  })
})